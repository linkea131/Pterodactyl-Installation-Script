...
webserver_options_uninstall() {
    output "Which Webserver do you want to remove?:\n[1] Nginx. \n[2] Apache2."
    read choice
    case $choice in
        1 ) webserver_config_uninstall_nginx
            output "You have selected to uninstall Nginx."
            output ""
            ;;
        2 ) webserver_config_uninstall_apache
            output "You have selected to uninstall Apache2/httpd."
            output ""
            ;;
        * ) output "You did not enter a valid selection to uninstall."
            webserver_options_uninstall
    esac
}
